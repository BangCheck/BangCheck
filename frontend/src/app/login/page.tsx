      ...
      <div className="w-[400px] h-[484px] border border-border-light rounded-[6px] flex flex-col items-center justify-center px-8 bg-white">
        <div className="flex flex-col items-center gap-[24px]">
          <div className="flex flex-col items-center gap-[38px]">
            ...
            <div className="flex flex-col gap-[10px]">
              <button
                ...
                disabled={!!isLoading}
                className={cn(
                  "flex items-center justify-center gap-[6px] w-[320px] py-[12px] bg-[#03A94D] rounded-[6px] transition-all cursor-pointer hover:brightness-95 active:scale-[0.98]",
              ...
              <button
                ...
                disabled={!!isLoading}
                className={cn(
                  "flex items-center justify-center gap-[6px] w-[320px] py-[12px] bg-white border border-[#E5E5E5] rounded-[6px] transition-all cursor-pointer hover:bg-gray-50 active:scale-[0.98]",
          ...
          <p className="text-[#a0a0a0] text-[12px] text-center leading-tight whitespace-nowrap">
            시작하기를 누르면{" "}
            <Link href="/terms" className="text-[#232527] font-regular">
              이용약관
            </Link>{" "}
            및{" "}
            <Link href="/privacy" className="text-[#232527] font-regular">
              개인정보 처리방침
            </Link>
            에 동의하게 됩니다.
          </p>
