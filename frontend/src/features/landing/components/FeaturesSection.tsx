...
const FEATURE_IMAGES = {
  checklist: '/images/landing/feature-checklist.png',
  distance:  '/images/landing/feature-distance.png',
  custom:    '/images/landing/feature-custom.png',
  compare:   '/images/landing/feature-compare.png',
};
...
export default function FeaturesSection() {
  return (
    <section className="px-10 md:px-[190px] py-[100px] md:py-[140px] w-full">
      <div className="flex flex-col gap-[100px] items-start max-w-[962px]">
        ...
        <div className="flex flex-col gap-[100px] items-start w-full">
          <FeatureRow
            imageSrc={FEATURE_IMAGES.checklist}
          ...
          />
          <FeatureRow
            imageSrc={FEATURE_IMAGES.distance}
          ...
          />
          <FeatureRow
            imageSrc={FEATURE_IMAGES.custom}
          ...
          />
          <FeatureRow
            imageSrc={FEATURE_IMAGES.compare}
            imageAlt="방 비교하기 화면"
            title="방 비교하기"
